...
"driver/Flash_Programming.src":"../driver/Flash_Programming.c" "driver/subdir.mk"
	cctc -cs --dep-file="$*.d" --misrac-version=2004 -D__CPU__=tc27xd "-fC:/Users/USER/AURIX-v1.10.6-workspace/p3/TriCore Debug (TASKING)/TASKING_C_C___Compiler-Include_paths__-I_.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc27xd -Y0 -N0 -Z0 -o "$@" "$<"
...
clean-driver:
	-$(RM) ./driver/Flash_Programming.d ./driver/Flash_Programming.o ./driver/Flash_Programming.src ./driver/asclin.d ./driver/asclin.o ./driver/asclin.src ./driver/can.d ./driver/can.o ./driver/can.src ./driver/start.d ./driver/start.o ./driver/start.src
